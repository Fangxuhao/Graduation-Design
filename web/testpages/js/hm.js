(function () {
    var h = {}, mt = {}, c = {
        id: "3e682fced3e1dc00867261bc54be759d",
        dm: ["365pcbuy.com"],
                    ...
                    if (d instanceof Array) {
                        ...
                        for (l = 0; l < g; l++) switch (n = d[l], typeof n) {
                            ...
                            case "unknown":
                                break;
                            default:
                                e && f.push(","), f.push(mt.r.stringify(n)), e = 1
                        }
                        f.push("]");
                        return f.join("")
                    }
    ...
    (function () {
        var b = mt.f, a = mt.r, e = mt.event, d = mt.lang, f = h.na, g = h.V, m = g.T, l = {
    ...
    (function () {
        var b = mt.lang, a = mt.f, e = mt.event, d = mt.h, f = h.o, g = h.B, m = h.V, l = m.T, n = +new Date, s = [],
            u = {
                U: function () {
                    return function (d) {
                                ...
                                if (a.getAttribute(e, f.Ca) == w) if (p) u.ga(u.pa(e, d)); else {
                                    ...
                                    if (b.J(k, "*") || b.J(k, z)) u.ga(u.pa(e, d)); else for (; e.parentNode != w;) {
                                        var p = e.parentNode, z = a.X(p), y = "a" === z && b.J(k, "a") ? t : x,
                                            ...
                                            G = a.getAttribute(p, f.Da) != w ? t : x;
                                        if (a.getAttribute(p, f.Ca) == w && (y || z || G)) {
                                            u.ga(u.pa(p, d));
                                            break
                                        }
                                        e = e.parentNode
                    ...
                    a.length > f.ka || (encodeURIComponent(s.join("!") + a).length > f.ka && (u.s(s.join("!")), s = []),
                        s.push(a))
                }, s: function (a) {
                    h.c.b.et = 5;
                    h.c.b.ep = a;
    ...
    (function () {
        var b = mt.event, a = mt.h, e = h.o, d = h.B, f = +new Date, g = [], m = w, l = {
            hb: function () {
                return function () {
                ...
                if (encodeURIComponent(g.join("!") + a).length > e.ka || 3 < g.length) l.s(g.join("!")), g = [];
                g.push(a)
            }, s: function (b) {
                h.c.b.et = 6;
                h.c.b.vh = a.O();
    ...
    (function () {
        var b = mt.f, a = h.o, e = h.load, d = h.mb;
        h.B.d("pv-b", function () {
    ...
    (function () {
        ...
        var e = mt.url, d = mt.lang, f = mt.r, g = mt.h, m = h.o, l = h.B, n = h.fb, s = h.load, u = h.la, q = h.V,
            v = q.T, k = {
                R: [], da: 0, Na: x,
                A: {Aa: "", page: ""}, init: function () {
                    ...
                    1 < a.length && t === a[1] && q.w("autoEventTracking")
    ...
    (function () {
        ...
        var a = mt.url, e = mt.Ta, d = mt.ya, f = mt.lang, g = mt.cookie, m = mt.h, l = mt.sessionStorage, n = mt.r,
            s = mt.event, u = h.la, q = h.V, v = q.T, k = h.o, p = h.load, z = h.B;
        b.prototype = {
            Q: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
    ...
    (function () {
        var b = mt.h, a = mt.lang, e = mt.event, d = mt.r;
    ...
    (function () {
        var b = mt.f, a = mt.lang, e = mt.event, d = mt.r;
