...
;!function (e, t) {
    ...
    var M = e.document, O = e.navigator, H = e.location, B = function () {
        ...
        var r, i, o, a, s = function (e, t) {
            ...
            h = /\d/, m = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, g = /^[\],:{}\s]*$/, y = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,
            v = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, b = /(?:^|:|,)(?:\s*\[)+/g,
            x = /(webkit)[ \/]([\w.]+)/, T = /(opera)(?:.*version)?[ \/]([\w.]+)/, w = /(msie) ([\w.]+)/,
            N = /(mozilla)(?:.*? rv:([\w.]+))?/, C = /-([a-z]|[0-9])/gi, E = /^-ms-/, S = function (e, t) {
                return (t + "").toUpperCase()
            }, A = O.userAgent, k = Object.prototype.toString, D = Object.prototype.hasOwnProperty,
            F = Array.prototype.push, j = Array.prototype.slice, L = String.prototype.trim, H = Array.prototype.indexOf,
            B = {};
    ...
    B.extend({
        _Deferred: function () {
            ...
            var n = arguments, r = 0, i = n.length, o = i,
    ...
    B.extend({
        ...
        data: function (e, n, r, i) {
            if (B.acceptData(e)) {
                var o, a, s = B.expando, l = "string" == typeof n, u = e.nodeType, c = u ? B.cache : e,
    ...
    var W, R, $ = /[\n\t\r]/g, X = /\s+/, z = /\r/g, V = /^(?:button|input)$/i,
        U = /^(?:button|input|object|select|textarea)$/i, J = /^a(?:rea)?$/i,
    ...
    B.event = {
        ...
        handle: function (n) {
            ...
            var r = ((B._data(this, "events") || {})[n.type] || []).slice(0), i = !n.exclusive && !n.namespace,
    ...
    B.each(["live", "die"], function (e, n) {
        ...
        var r = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,
            i = 0, o = Object.prototype.toString, a = !1, s = !0, l = /\\/g, u = /\W/;
        [0, 0].sort(function () {
            return s = !1, 0
        });
        ...
        var f = c.selectors = {
            ...
            filter: {
                PSEUDO: function (e, t, n, r) {
                    ...
                    var n = t[1], r = f.attrHandle[n] ? f.attrHandle[n](e) : null != e[n] ? e[n] : e.getAttribute(n),
                        i = r + "", o = t[2], a = t[4];
    ...
    var lt = /Until$/, ut = /^(?:parents|prevUntil|prevAll)/, ct = /,/, ft = /^.[^:#\[\.,]*$/,
        dt = Array.prototype.slice, pt = B.expr.match.POS, ht = {children: !0, contents: !0, next: !0, prev: !0};
    B.fn.extend({
        find: function (e) {
            var t, n, r = this;
    ...
    var mt = / jQuery\d+="(?:\d+|null)"/g, gt = /^\s+/,
        yt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, vt = /<([\w:]+)/,
        bt = /<tbody/i, xt = /<|&#?\w+;/, Tt = /<(?:script|object|embed|option|style)/i,
        wt = /checked\s*(?:[^=]|=\s*.checked.)/i, Nt = /\/(java|ecma)script/i, Ct = /^\s*<!(?:\[CDATA\[|\-\-)/, Et = {
        ...
        clone: function (e, t, n) {
            ...
            for (var o, a, s = [], l = 0; null != (a = e[l]); l++) if ("number" == typeof a && (a += ""), a) {
                if ("string" == typeof a) if (xt.test(a)) {
                    a = a.replace(yt, "<$1></$2>");
                    var u = (vt.exec(a) || ["", ""])[1].toLowerCase(), c = Et[u] || Et._default, f = c[0],
    ...
    var St, At, kt, Dt = /alpha\([^)]*\)/i, Ft = /opacity=([^)]*)/, jt = /([A-Z]|^ms)/g, Lt = /^-?\d+(?:px)?$/i,
        Mt = /^-?\d/, Ot = /^([\-+])=([\-+.\de]+)/, Ht = {position: "absolute", visibility: "hidden", display: "block"},
    ...
    B.fn.css = function (e, n) {
        ...
        get: function (e, t) {
            ...
            var n = e.style, r = e.currentStyle, i = B.isNaN(t) ? "" : "alpha(opacity=" + 100 * t + ")",
    ...
    var qt, It, _t = /%20/g, Wt = /\[\]$/, Rt = /\r?\n/g, $t = /#.*$/, Xt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        ...
        Vt = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, Ut = /^(?:GET|HEAD)$/, Jt = /^\/\//,
        Yt = /\?/, Gt = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, Kt = /^(?:select|textarea)/i, Qt = /\s+/,
        Zt = /([?&])_=[^&]*/, en = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, tn = B.fn.load, nn = {}, rn = {},
        on = ["*/"] + ["*"];
    try {
        qt = H.href
    } catch (an) {
    ...
    It = en.exec(qt.toLowerCase()) || [], B.fn.extend({
        ...
        ajax: function (e, n) {
            ...
            var i, o, a, s, l, f, d, h, m = B.ajaxSetup({}, n), g = m.context || m,
                y = g !== m && (g.nodeType || g instanceof B) ? B(g) : B.event, v = B.Deferred(), b = B._Deferred(),
                x = m.statusCode || {}, T = {}, w = {}, N = 0, C = {
    ...
    B.ajaxSetup({
        ...
        if ("jsonp" === t.dataTypes[0] || t.jsonp !== !1 && (ln.test(t.url) || i && ln.test(t.data))) {
            var o, a = t.jsonpCallback = B.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s = e[a],
    ...
    var dn, pn, hn, mn, gn = {}, yn = /^(?:toggle|show|hide)$/, vn = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,
    ...
    B.fn.extend({
        show: function (e, t, n) {
            ...
            return B.isEmptyObject(e) ? this.each(o.complete, [!1]) : (e = B.extend({}, e), this[o.queue === !1 ? "each" : "queue"](function () {
                ...
                var t, n, i, a, s, l, u, c, f, d = B.extend({}, o), p = 1 === this.nodeType,
    ...
    B.fn.offset = "getBoundingClientRect" in M.documentElement ? function (e) {
        ...
        var s = o.body, l = n(o), u = a.clientTop || s.clientTop || 0, c = a.clientLeft || s.clientLeft || 0,
            f = l.pageYOffset || B.support.boxModel && a.scrollTop || s.scrollTop,
            d = l.pageXOffset || B.support.boxModel && a.scrollLeft || s.scrollLeft, p = t.top + f - u,
            h = t.left + d - c;
        return {top: p, left: h}
    } : function (e) {
        var t = this[0];
        ...
        initialize: function () {
            var e, t, n, r = M.body, i = M.createElement("div"), o = parseFloat(B.css(r, "marginTop")) || 0,
            ...
            var i, o, a = B(e), s = a.offset(), l = B.css(e, "top"), u = B.css(e, "left"),
                c = ("absolute" === r || "fixed" === r) && B.inArray("auto", [l, u]) > -1, f = {}, d = {};
...
!function (e) {
    ...
    e.browser = e.browser || function () {
        var e = navigator.userAgent.toLowerCase(), t = /(webkit)[ \/]([\w.]+)/,
            a = /(opera)(?:.*version)?[ \/]([\w.]+)/, n = /(msie) ([\w.]+)/, i = /(mozilla)(?:.*? rv:([\w.]+))?/,
    ...
    jQuery.cookie = function (e, t, a) {
        ...
        var l = a.path ? "; path=" + a.path : "", u = a.domain ? "; domain=" + a.domain : "",
            m = a.secure ? "; secure" : "";
    ...
    e.extend(e, {
        md5: function (e) {
            var t, n, i, r, c, p, f, d, b, y = Array(), w = 7, k = 12, x = 17, v = 22, _ = 5, C = 9, R = 14, z = 20,
                j = 4, S = 11, A = 16, G = 23, q = 6, P = 10, D = 15, L = 21;
...
if (window.ADData) ADBase.flag && (ADData.isInit = !0); else var ADData = window.ADData = {list: []},
...
var ADBase = function (e) {
    ...
    var l = e.jQuery || e.Zepto, u = (e.nie, e.__GetScript), m = e.JSON, h = e.LocalData,
...
!function (e) {
    ...
    nie.util.copyRight = nie.util.copyRight || function () {
        ...
        if (t.length > 0 || a.length > 0) {
            var n = e.host + "/comm/NIE_copyRight/images/", i = "", r = "\u6587\u7f51\u6e38\u5907\u5b57",
                c = "\u6587\u7f51\u5907\u5b57", o = "", s = "\u7ca4\u7f51\u6587[2014]0636-236\u53f7",
                l = "\u6587\u7f51\u6587[2009]156\u53f7", u = "\u6d59\u7f51\u6587[2016]0155-055\u53f7", m = "", h = "",
                g = !0, p = 16, f = "\u672c\u6e38\u620f\u6545\u4e8b\u60c5\u8282\u8bbe\u7f6e\u7d27\u51d1", d = "",
